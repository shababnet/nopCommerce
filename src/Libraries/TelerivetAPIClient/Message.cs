...
namespace Telerivet.Client
{
    ...
    public class Message : Entity
    {
        ...
        */
        ...
        public Nullable<long> TimeCreated
        {
            get
            {
                return (Nullable<long>)Get("time_created");
            }
        }

        public Nullable<long> TimeSent
        {
            get
            {
                return (Nullable<long>)Get("time_sent");
            }
        }
        ...
        public Nullable<Decimal> Price
        {
            get
            {
                return (Nullable<Decimal>)Get("price");
            }
        }
        ...
        public Nullable<long> RingTime
        {
            get
            {
                return (Nullable<long>)Get("ring_time");
            }
        }
